...
import React, { useState, useEffect } from 'react';
import { X, DollarSign, Banknote, Smartphone } from 'lucide-react';
import { PaymentMethod } from '../types';
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl p-6 animate-in zoom-in-95">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                autoFocus
                onChange={(e) => setAmount(e.target.value)}
                className="w-full bg-gray-50 border border-gray-200 rounded-xl p-3 pr-10 text-lg font-bold outline-none focus:border-primary"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-xl font-bold shadow-lg transition flex items-center justify-center gap-2"
          >
            <DollarSign size={20} />
            تأكيد التحصيل
          </button>
