...
function createWindow() {
  ...
  // Open DevTools automatically in development mode or when --dev flag is passed
  const isDev = process.env.ELECTRON_DEV === 'true' || process.env.NODE_ENV !== 'production' || process.argv.includes('--dev');
  if (isDev) {
